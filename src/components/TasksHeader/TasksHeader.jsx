export const TasksHeader = () => {
    return (
        <div className="group/hea grid xl:grid-cols-8 items-center max-[768px]:flex justify-between xl:p-2 px-2 max-[1200px]:mr-32 max-[768px]:mr-4 max-[500px]:m-0 max-[500px]:p-0">
